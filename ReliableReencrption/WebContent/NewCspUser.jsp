...
<div style="position: absolute; left: 500px; top: 220px;"><!-- heading div tag -->
<span style="font-weight: bold; color: #95F11C;font-size: 20px;font-family: Verdana;">SITE OWNER/SITE MANAGER</span>
</div>
...
<tr><td>EmailAddress:</td><td><input type=text name=eaddress></input></td></tr>
...
<option value=''>--Select--</option>
  <option value='owner'>SiteOwner</option>
  <option value='manager'>SiteManager</option>
