...
public class ServerManager extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String mserver=request.getParameter("mserver");
		String kserver=request.getParameter("kserver");
		int size=new Integer(mserver)+new Integer(kserver);
		DbHandler.addMKServer(size);
